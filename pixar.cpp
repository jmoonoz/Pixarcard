//
// Joel Munoz
// github: https://github.com/jmoonoz
// instgra @MoonozDisenoz
//email: j.munoz1@yahoo.com
...
//random float integer between 0 and 1
F U()
{
	R (F)rand()/RAND_MAX;
}
...
F S(V p,I &m)
{
	...
	V f=p;
	f.z=0;
	// this is where the lettering is encoding in (pixar)
	char l[]="505_5W9W5_9_COC_AOEOA_E_IOQ_I_QOUOY_Y_]OWW[WaOa_aWeWa_e_cWiO"; 
	for(I i=0;i < 60;i+=4)
	{
